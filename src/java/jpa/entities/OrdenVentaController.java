...
public class OrdenVentaController implements Serializable {
    ...
    @EJB
    private jpa.entities.OrdenVentaFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("OrdenVentaCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("OrdenVentaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("OrdenVentaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public OrdenVenta getOrdenVenta(java.lang.Integer id) {
    ...
    public static class OrdenVentaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof OrdenVenta) {
                ...
                return getStringKey(o.getIdOrdenVenta());
            } else {
